...
public class CodingPlugin
{
    ...
    public CodingPlugin(string? workDir = null)
    {
        ...
        [Description("The shell command to execute")] string command)
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(output))
                Console.WriteLine(output.Length > 500 ? output[..500] + "..." : output);
            else
    ...
    // =========================================================================
    // Tool 4: Edit File - Surgical text replacement
    // =========================================================================
    ...
    // =========================================================================
    // Tool 5: Grep - Search files with regex
    // =========================================================================

    [KernelFunction("grep")]
    [Description("Search files for a pattern (regex). Returns matching lines in file:line:content format. Recursively searches directories.")]
    public string Grep(
