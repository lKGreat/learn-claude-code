...
public partial class WebPlugin
{
    ...
    public WebPlugin(IOutputSink output)
    {
        _output = output;
    }
    ...
    {
        _output.WriteDebug($"[web] Searching: {query}");
        ...
        try
        {
            ...
            _output.WriteDebug($"[web] Found {results.Count} results");
            return sb.ToString();
        }
        catch (Exception ex)
        {
    ...
    {
        _output.WriteDebug($"[web] Fetching: {url}");
        ...
        try
        {
            ...
            _output.WriteDebug($"[web] Fetched {text.Length} chars from {uri.Host}");
